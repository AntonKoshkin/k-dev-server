...
Нашел ее в |||Jata.ru|https://jata.ru|||, маленьком стартапе на тот момент. Сверстал там все, что было, и фронтендер, который интегрировал мои изыски в AngularJS, начал знакомить меня с этим фреймворком.
